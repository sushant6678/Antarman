...
const Profile = ({ doctorData }) => {
  ...
  const handleLicenseInputChange = async (event) => {
    const file = event.target.files[0];
    const data = await uploadImageToCloudinary(file);

    setLicenseFile(data.url);
    setFormData({ ...formData, license: data.url });
  };
  ...
  return (
    <div>
      ...
      <form>
          ...
          <div className="grid grid-cols-3 gap-5 mb-[30px]">
            ...
            <div>
              ...
              >
                ...
                <option value="mentalhealthcounselor">Mental Health Counselor</option>
        ...
        {licenseFile && (
          <figure className="w-[60px] h-[60px] rounded-full border-2 border-solid border-[#0067FF] flex items-center justify-center">
            <img src={licenseFile} alt="License Preview" className="w-full rounded-full" />
          </figure>
        )}
        ...
        <div className="relative inline-block w-[130px] h-[50px]">
          ...
          <label
            ...
            htmlFor="customFile"
          >
            {selectedFile ? selectedFile.name : "Upload Profile"}
          </label>
        </div>
